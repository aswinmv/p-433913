  ...
  return (
    <section className="mt-[30px] max-md:mt-8 max-sm:mt-6 flex flex-col md:flex-row gap-8">
      <div className="w-full md:w-1/2">
        <h2 className="text-[40px] font-bold mb-4 max-sm:text-[28px]">Send a Message</h2>
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-3">
            ...
            <span className="max-sm:text-sm">+123-456-7890</span>
          </div>
          <div className="flex items-center gap-3">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="max-sm:text-sm">aswinmv.ux@gmail.com</span>
          </div>
        </div>
      </div>
      <div className="w-full md:w-1/2 bg-white p-8 rounded-lg shadow-sm max-sm:p-4">
        <div className="flex flex-col gap-5">
          ...
          <Button className="w-full bg-black text-white py-6 max-sm:py-4 max-sm:text-sm">Send Message</Button>
        </div>
      </div>
    </section>
  );
